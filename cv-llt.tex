%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Enhanced CV Template — Mohammad Amirfattahi
...
\leftheader{%
  ...
  {\large\textit{Data Scientist | Database Developer | ML Engineer}} \\[0.8ex]
  ...
  \makefield{\faMapMarker*}{\texttt{Tehran, Iran}} \\[0.4ex]
  % Optional additions:
  % \makefield{\faLinkedin}{\href{https://www.linkedin.com/in/mohammad-amirfattahi}{linkedin.com/in/mohammad-amirfattahi}} \\[0.4ex]
  % \makefield{\faGithub}{\href{https://github.com/yourprofile}{github.com/yourprofile}}
}
